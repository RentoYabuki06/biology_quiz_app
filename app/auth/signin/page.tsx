        ...
        <div className="card">
          <div className="space-y-6">
            ...
            <p className="text-xs text-gray-500 text-center">
              ログインすることで、
              <a href="#" className="text-primary-600 hover:text-primary-500">利用規約</a>
              と
              <a href="#" className="text-primary-600 hover:text-primary-500">プライバシーポリシー</a>
              に同意したものとみなされます。
            </p>
          </div>
        </div>
